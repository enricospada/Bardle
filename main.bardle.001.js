...
this.wordle.bundle = function(e) {
    ...
    Ka.innerHTML = "\n  <style>\n  .toaster {\n    position: absolute;\n    top: 10%;\n    left: 50%;\n    transform: translate(-50%, 0);\n    pointer-events: none;\n    width: fit-content;\n  }\n  #game-toaster {\n    z-index: ".concat(1e3, ";\n  }\n  #system-toaster {\n    z-index: ").concat(4e3, ';\n  }\n\n  #game {\n    width: 100%;\n    max-width: var(--game-max-width);\n    margin: 0 auto;\n    height: 100%;\n    display: flex;\n    flex-direction: column;\n  }\n  header {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    height: var(--header-height);\n    color: var(--color-tone-1);\n    border-bottom: 1px solid var(--color-tone-4);\n  }\n  header .title {\n    font-family: "Estonia", cursive, serif; \n font-weight: 700;\n    font-size: 44px;\n    letter-spacing: 0.2rem;\n    text-transform: uppercase;\n    text-align: center;\n    position: absolute;\n    left: 0;\n    right: 0;\n    pointer-events: none;\n  }\n\n  @media (max-width: 360px) {\n    header .title {\n      font-size: 22px;\n      letter-spacing: 0.1rem;\n    }\n  }\n\n  #board-container {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    flex-grow: 1;\n    overflow: hidden;\n  }\n  #board {\n    display: grid;\n    grid-template-rows: repeat(6, 1fr);\n    grid-gap: 5px;\n    padding:10px;\n    box-sizing: border-box;\n  }\n  button.icon {\n    background: none;\n    border: none;\n    cursor: pointer;\n    padding: 0 4px;\n  }\n\n  #debug-tools {\n    position: absolute;\n    bottom: 0;\n  }\n\n  </style>\n  <game-theme-manager>\n    <div id="game">\n      <header>\n        <div class="menu">\n          <button id="help-button" class="icon" aria-label="help">\n            <game-icon icon="help"></game-icon>\n          </button>\n        </div>\n        <div class="title estonia">\n         BARDLE\n        </div>\n        <div class="menu">\n          <button id="statistics-button" class="icon" aria-label="statistics">\n            <game-icon icon="statistics"></game-icon>\n          </button>\n          <button id="settings-button" class="icon" aria-label="settings">\n            <game-icon icon="settings"></game-icon>\n          </button>\n        </div>\n      </header>\n        <div id="board-container">\n          <div id="board"></div>\n        </div>\n        <game-keyboard></game-keyboard>\n        <game-modal></game-modal>\n        <game-page></game-page>\n        <div class="toaster" id="game-toaster"></div>\n        <div class="toaster" id="system-toaster"></div>\n    </div>\n  </game-theme-manager>\n  <div id="debug-tools"></div>\n');
    var Qa = document.createElement("template");
    Qa.innerHTML = '\n<button id="reveal">reveal</button>\n<button id="shake">shake</button>\n<button id="bounce">bounce</button>\n<button id="toast">toast</button>\n<button id="modal">modal</button>\n';
    var Za = "IN_PROGRESS"
      , es = "WIN"
      , as = "FAIL"
      , ss = ["...and some have greatness thrust upon them", "Some achieve greatness...", "To do a great right do a little wrong", "So shines a good deed", "There is nothing either good or bad but thinking makes it so", "Zounds"]
      , ts = function(e) {
        r(t, e);
        var a = h(t);
        function t() {
  ...
  ***************************************************************************** */
    ...
    $s.innerHTML = '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n a, a:visited {\n    color: var(--color-tone-2);\n  }\n \n  </style>\n  <section>\n    <div class="instructions">\n <p>Welcome to <strong>BARDLE</strong>, a Shakespearean guessing game. You have 6 tries to guess the word.</p>\n <p>For each guess, you will receive clues as to how close you are to being correct:</p>\n <div class="examples">\n <div class="example">\n <div class="row">\n <game-tile letter="r" evaluation="correct" reveal></game-tile>\n <game-tile letter="o"></game-tile>\n <game-tile letter="m"></game-tile>\n <game-tile letter="e"></game-tile>\n <game-tile letter="o"></game-tile>\n </div>\n <p>The letter <strong>R</strong> is in the word and in the correct spot.</p>\n </div>\n <div class="example">\n <div class="row">\n <game-tile letter="s"></game-tile>\n <game-tile letter="c" evaluation="present" reveal></game-tile>\n <game-tile letter="r"></game-tile>\n <game-tile letter="i"></game-tile>\n <game-tile letter="p"></game-tile>\n </div>\n <p>The letter <strong>C</strong> is in the word but in the wrong spot.</p>\n </div>\n <div class="example">\n <div class="row">\n <game-tile letter="t"></game-tile>\n <game-tile letter="w"></game-tile>\n <game-tile letter="i"></game-tile>\n <game-tile letter="x" evaluation="absent" reveal></game-tile>\n <game-tile letter="t"></game-tile>\n </div>\n <p>The letter <strong>X</strong> is not in the word in any spot.</p>\n </div>\n </div>\n <p><strong>NOTE:</strong> The word list contains only 5-letter words found in the plays of William Shakespeare. It does NOT include: plural nouns ending in "s" ("coins"), present tense verbs ("jests"),or contractions ("lov\'st"). Proper nouns ARE included (characters and places).</p>\n <p><strong>Check back every day for a new BARDLE!</strong></p>\n <p><small>Inspired by, with gratitude, the amazing and popular game <strong><a href="https://www.powerlanguage.co.uk/wordle/" target="_blank">WORDLE</a></strong> by Josh Wardle.</small></p>\n	</div>\n  </section>\n';
    var Hs = function(e) {
        r(t, e);
        var a = h(t);
        function t() {
